        ...
        <div className="relative z-10 w-full flex items-center justify-center px-4 sm:px-6 md:px-16">
          <div className="w-full max-w-4xl text-center">
            ...
            >
              ...
              <div className="relative bg-white/20 backdrop-blur-xl rounded-3xl pt-4 pb-6 px-4 sm:px-8 md:pb-10 md:px-12 border border-white/30 shadow-2xl shadow-black/20 h-[390px] sm:h-[400px] md:h-auto overflow-hidden">
                ...
                {/* Logo */}
                <div className="relative mb-2 md:mb-4 z-10">
