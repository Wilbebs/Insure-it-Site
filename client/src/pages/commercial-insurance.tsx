...
export default function CommercialInsurance() {
  return (
    <div className="min-h-screen">
      ...
      {/* Hero Section */}
      <section className="pt-32 pb-20 bg-gradient-to-br from-orange-50 to-amber-100">
      ...
      <section className="py-20">
        <div className="container mx-auto px-6">
          <h2 className="text-4xl font-bold text-center mb-16 gradient-text">Business Protection Solutions</h2>
